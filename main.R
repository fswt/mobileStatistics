...
stairsData <- load_data("./z_data/stairs_prepro")
...
#boxplot 
box_plots(fab_subsets$sub_up_without_linAcc,fab_subsets$sub_up_with_linAcc,fab_subsets$sub_down_without_linAcc,fab_subsets$sub_down_with_linAcc)
...
stripchart(round(fab_subsets$sub_up_without_linAcc$magnitude,2) ~fab_subsets$sub_up_without_linAcc$statusId, method="stack")

stripchart(fab_subsets$sub_up_without_linAcc$magnitude ~ fab_subsets$sub_up_without_linAcc$statusId, method="jitter", jitter=0.3)


#T test down
mean_down_with <-c(mean(fab_subsets$sub_down_with_linAcc$magnitude),mean(mel_subsets$sub_down_with_linAcc$magnitude),mean(jua_subsets$sub_down_with_linAcc$magnitude))
mean_down_without <-c(mean(fab_subsets$sub_down_without_linAcc$magnitude),mean(mel_subsets$sub_down_without_linAcc$magnitude),mean(jua_subsets$sub_down_without_linAcc$magnitude))
#t test: 
t.test(mean_down_with,mean_down_without, alternative = "less", paired = TRUE)

#T test up 
mean_up_with <-c(mean(fab_subsets$sub_up_with_linAcc$magnitude),mean(mel_subsets$sub_up_with_linAcc$magnitude),mean(jua_subsets$sub_up_with_linAcc$magnitude))
mean_down_without <-c(mean(fab_subsets$sub_up_without_linAcc$magnitude),mean(mel_subsets$sub_up_without_linAcc$magnitude),mean(jua_subsets$sub_up_without_linAcc$magnitude))
#t test: 
t.test(mean_down_without,mean_up_with, alternative = "less", paired = TRUE)
