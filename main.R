...
TASK_NAMES <- list("up_without_weight", "up_with_weight", "down_without_weight", "down_with_weight")
par(mar = rep(2, 4))
...
#creating plots
test_plot(subjects_subsets[[16]]$sub_up_without_linAcc,subjects_subsets[[16]]$sub_up_with_linAcc,"Plot_R7","_plot_linAcc","Seconds","Acceleration Magnitude")
plot_histograms(subjects_subsets[[16]], ylim=c(0,0.35), xlim=c(0,25))
plot_ecdf(subjects_subsets[[16]])
plot_qq(subjects_subsets[[16]])
plot_box(subjects_subsets[[16]])

plot_hist_vs_ecdf(subjects_subsets[[16]][[1]], subjects_subsets[[16]][[2]], ylim=c(0,0.35), xlim=c(0,25), task_name_one=TASK_NAMES[[1]], task_name_two=TASK_NAMES[[2]])
plot_hist_vs_qq(subjects_subsets[[16]][[1]], subjects_subsets[[16]][[2]], ylim=c(0,0.35), xlim=c(0,25), task_name_one=TASK_NAMES[[1]], task_name_two=TASK_NAMES[[2]])
plot_hist_vs_ecdf(subjects_subsets[[16]][[1]], subjects_subsets[[16]][[2]], ylim=c(0,0.35), xlim=c(0,25), task_name_one=TASK_NAMES[[1]], task_name_two=TASK_NAMES[[2]])
...
plot_all_stripcharts(subjects_data[[16]],method="jitter", jitter=0.4)
